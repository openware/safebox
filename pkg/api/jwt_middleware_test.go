...
func TestParseJWT(t *testing.T) {
	...
	t.Run("Valid token not expired", func(t *testing.T) {
		// Expiration date: 1575081480
		jwt.TimeFunc = func() time.Time {
			return time.Unix(1575081470, 0)
		}
	...
	t.Run("Valid token but expired", func(t *testing.T) {
		// Expiration date: 1575081480
		jwt.TimeFunc = func() time.Time {
			return time.Unix(1575081490, 0)
		}
		token := "eyJhbGciOiJSUzI1NiJ9..AZXLXuitWXC9lGldLxI9uy0iolpD7en7AiutA_Ahb7bkoQ73L4_uXBOeC0GyJFoXqtKNdkr-rSNDDGAfpcCxNxA6D4p2vjrrsOaQxUm4qgb12702w1wYRjdyHso_IETbiF_HUNcEoaMBLV-YKBSvuNkt5ypIrhcDvtQvpmczZ9j57uHsOCAL7OahkUjnduqczODovr8rFY2yxZ8khu0MJ4ND2iHTDR8lUlJ44a9Rw_WFewF_edzLBS9WWQYz_7TllEov5fozm9rL0cD0pmotIJdabOdwX76zaIITxU1zRdDtNST-10lVKDjvM2kb59Du92Yhr-CuFCae9Z6I6fz_kw"
		claims, err := ParseJWT(token, FakeKeyFunc("sample"))
		assert.Error(t, err)
		assert.Nil(t, claims)
		assert.Equal(t, "token is expired by 10s", err.Error())
		jwt.TimeFunc = time.Now
	})
